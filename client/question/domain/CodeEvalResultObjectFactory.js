...
tie.factory('CodeEvalResultObjectFactory', [
  function() {
     ...
     * property. The function should return a triply-nested array, where each
     * nesting level represents the results for each task, suite, and test case.
     * The elements of the innermost list are the outputs generated by the
     * learner's program for the corresponding correctness test.
     *
     * @returns {Array}
     */
     ...
     * from the correctnessTests. The function should return the last subarray
     * in _correctnessTestResults.
     *
     * @returns {Object}
     */
