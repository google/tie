...
globalData.questions['increment'] = {  // eslint-disable-line dot-notation
...
`
  ...
  tasks: [{
    ...
    buggyOutputTests: [{
      buggyFunctionName: 'AuxiliaryCode.forgetLastCarry',
      messages: [
        "Try running your code on '999' on paper. What's the result?",
        "Are you sure that you're add all numbers?",
        [
