...
`
  ...
  tasks: [{
    ...
    buggyOutputTests: [{
      buggyFunctionName: 'AuxiliaryCode.applyArray',
      messages: [
	"Since there are few possible characters, is there a data structure better than array?"
      ]
    }],
    performanceTests: []
  }, {
